...
function estate_listing_details($post_id,$wpestate_prop_all_details='',$columns=''){
    ...
    if ($property_second_price != 0) {
        $property_second_price =wpestate_show_price_from_all_details($wpestate_currency,$where_currency,1,$wpestate_prop_all_details,"yes");
    }else{
    ...
    // energy saving
    if ($energy_index != '')    {
        $return_string.= '<div class="listing_detail col-md-'.$colmd.' property_default_energy_index"><strong>'.esc_html__('Energy index','wpresidence').':</strong> ' . $energy_index . ' kWh/m²a</div>';
    }
    if ($energy_class != '')    {
        $return_string.= '<div class="listing_detail col-md-'.$colmd.' property_default_energy_index_class "><strong>'.esc_html__('Energy class','wpresidence').':</strong> ' . $energy_class . '</div>';
    }
    // ee end
