...
function wpestate_scripts() {
    ...
    $control_dependencies = array('jquery','slick.min');
    ...
    if (    is_singular( 'estate_property') || 
            ...
            $page_template=='user_dashboard_main.php' || 
            wpestate_is_property_modal()  ||   
            $page_template=='page_property_design.php' ){
    ...
    if ( $page_template == 'user_dashboard_add_agent.php' || 
         $page_template == 'user_dashboard_add.php' ||
         $page_template == 'user_dashboard_profile.php' || 
         $page_template == 'front_property_submit.php' ){
        ...
        if($custom_image    ==  ''){
          wp_enqueue_script('googlecode_contact', get_theme_file_uri('/js/google_js/google_map_code_contact'.$mimify_prefix.'.js'),array('jquery','wpestate_mapfunctions_base'), $theme_object->Version, true);
            ...
            if($header_type==5 || $global_header_type==4 || $tax_header==4){
                ...
                if ( $page_template=='property_list.php'  ){
   ...
   $measure_sys             = wpresidence_get_option('wp_estate_measure_sys','');
    ...
    if( $page_template=='user_dashboard_add.php' || 
        $page_template=='user_dashboard_profile.php' || 
        $page_template=='property_list.php' ){
        $load_extra=1;
    }
    ...
    if( $page_template=='advanced_search_results.php' &&  intval(wpresidence_get_option('wp_estate_property_list_type_adv') )==2 ) {
        $is_half_map_list=1;
    }
    ...
    if( $page_template=='property_list_directory.php' ){
    ...
    if( $page_template=='front_property_submit.php' ){
    ...
    if( $page_template=='user_dashboard_profile.php' ||
        $page_template=='user_dashboard_add.php'  || 
        $page_template=='user_dashboard_add_agent.php'  ||
        $page_template=='front_property_submit.php' ){
        ...
        if($page_template=='user_dashboard_add.php' ||   $page_template=='front_property_submit.php' ){
