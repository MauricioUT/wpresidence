...
<div class="row">
    <div  id="google_map_prop_list_wrapper" class="half_mobile_hide google_map_prop_list <?php echo esc_attr( $top_bar_style.' half_'.$logo_header_type); ?> 
          half_position_<?php echo esc_attr($half_map_position);?> "  >
        <?php include( locate_template('templates/google_maps_base.php')); ?>
    </div>    
    
    
    <div id="google_map_prop_list_sidebar" class="<?php echo esc_attr( $top_bar_style.' half_'.$logo_header_type) ;?> half_position_<?php echo esc_attr($half_map_position);?>">
        <?php 
        $show_mobile=1;
