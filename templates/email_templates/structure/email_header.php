<?php 
$logo_source      =  wpresidence_get_option('wp_estate_email_logo_image', 'url');
$show_email_header=  wpresidence_get_option('wpestate_display_header_email', 'url');
$email_back       =  get_stylesheet_directory_uri().'/email_templates/images/email_back.png'; 


$wp_estate_email_background=  wpresidence_get_option('wp_estate_email_background', '');
...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Nunito+Sans:300,400,600,700,800,900&subset=latin,latin-ext&display=swap" rel="stylesheet">
    <title>WpResidence</title>
    <!--[if mso]>
    <xml>
