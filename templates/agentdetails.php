    ...
    <div class="col-md-<?php print esc_attr($pict_size);?> agentpic-wrapper">
            ...
            <div class="agent_unit_social_single">
                    ...
                    if($realtor_details['realtor_facebook']!=''){
                        print ' <a href="'. esc_url($realtor_details['realtor_facebook']).'" target="_blank"  rel="noopener" ><i class="fab fa-facebook-f"></i></a>';
                    }

                    if($realtor_details['realtor_twitter']!=''){
                        print ' <a href="'.esc_url($realtor_details['realtor_twitter']).'" target="_blank" rel="noopener" ><i class="fab fa-twitter"></i></a>';
                    }
                    if($realtor_details['realtor_linkedin']!=''){
                        print ' <a href="'.esc_url($realtor_details['realtor_linkedin']).'" target="_blank" rel="noopener" ><i class="fab fa-linkedin"></i></a>';
                    }
                    if($realtor_details['realtor_pinterest']!=''){
                        print ' <a href="'. esc_url($realtor_details['realtor_pinterest']).'" target="_blank" rel="noopener" ><i class="fab fa-pinterest"></i></a>';
                    }
                    if($realtor_details['realtor_instagram']!=''){
                        print ' <a href="'. esc_url($realtor_details['realtor_instagram']).'" target="_blank" rel="noopener" ><i class="fab fa-instagram"></i></a>';
                    }
                    ?>
