...
require_once  get_theme_file_path('/libs/dashboard_functions.php');
require_once  get_theme_file_path('/libs/dashboard_actions_functions.php');
require_once  get_theme_file_path('/templates/login_register_modal.php');
...
require_once  get_theme_file_path('/libs/header_filter_functions.php');
require_once  get_theme_file_path('/libs/gallery_functions.php');
...
if( !function_exists('wpestate_manage_admin_menu') ):
    ...
    function wpestate_manage_admin_menu() {
        $theme = wp_get_theme();
        add_submenu_page( $theme->get( 'Name' ),'Import Demo', 'Import Demo', 'administrator', 'themes.php?page=one-click-demo-import', '' );
        add_submenu_page( 'libs/theme-admin.php','Import Demo', 'Import Demo', 'administrator', 'themes.php?page=one-click-demo-import', '' );
...
function ocdi_import_files_new() {
    ...
    if($demos_data==false){
        $enquire_answer  =  wpestate_enquire_license(get_option('envato_purchase_code_7896392',true));
...
function wpestate_build_dropdown_adv_new($appendix,$ul_id,$toogle_id,$values,$values1,$get_var,$select_list,$active=''){
    ...
    if($adv_search_type==6){
        ...
        <div data-toggle="dropdown" id="'.sanitize_key( $appendix.$toogle_id ).'" class="'.$extraclass.'" xxmaca caca'.$values1.' '.$values.' data-value="'.( esc_attr( $current_val1) ).'">';
