...
<div class="row">
    ...
    ?>
       ...
       // endwhile; // end of the loop
        ...
        if($enable_global_property_page_agent_sidebar=='no'){
        ...
        if(wpresidence_get_option('wp_estate_show_reviews_prop','')=='yes'){
            include( locate_template ('/templates/listing_templates/property_reviews.php' ) );
        }
        

        //SIMIALR LISTINGS
        include( locate_template ('/templates/listing_templates/similar_listings.php' ) );
        ?>
